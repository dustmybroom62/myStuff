...
def isValidWord(word, hand, wordList):
    ...
    for c in letterCount.keys():
        if letterCount[c] > hand.get(c, 0):
            return False
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    handOver = False
    while not handOver:
        if 1 > calculateHandlen(hand):
            handOver = True
            finalMsg = "Run out of letters."
            break
    ...
    print(finalMsg, "Total score:", totalScore, "points.")
    print()
