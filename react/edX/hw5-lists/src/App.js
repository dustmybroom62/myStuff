...
class App extends Component {
  ...
  handleAddList(s) {
      ...
      var newListName = s.value;
      var newItems = this.state.items;
      newItems[newListName] = [];

      this.setState( { 
        lists: this.state.lists.concat(newListName),
        items: newItems
      });
  }
  ...
  handleAddItem(s) {
      // Implement this function!
      var listName = s.idName;
      var newItem = s.newItem;
      var items = this.state.items;

      items[listName].push(newItem);
