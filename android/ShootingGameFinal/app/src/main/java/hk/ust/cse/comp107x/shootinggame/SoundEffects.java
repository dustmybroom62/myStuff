...
public enum SoundEffects {
    ...
    public void playSound(int sound) {
        mSoundPool.stop(lastPlay);
        lastPlay = mSoundPool.play(mSoundPoolMap.get(sound),streamVolume, streamVolume, 100, 0, 1f);
        Log.i("SoundEffects", String.format("Playing Sound: %1$d, result: %2$d", sound, lastPlay));
    }
}
