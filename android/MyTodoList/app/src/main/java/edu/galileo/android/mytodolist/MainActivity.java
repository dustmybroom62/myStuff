package edu.galileo.android.mytodolist;
...
import edu.galileo.android.mytodolist.AddTaskDialogFragment.AddTaskDialogListener;
import edu.galileo.android.mytodolist.TodoCursorAdapter.ToggleTodoCheckListener;
...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>,
    ...
    private ContentValues getTodoListContentValues(String stringValue) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(TodoEntry.COLUMN_DESCRIPTION, stringValue);
        contentValues.put(TodoEntry.COLUMN_DATE, Calendar.getInstance().getTimeInMillis());
